...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .querySelector(".testimonial-controls .next")
    .addEventListener("click", function () {
  ...
  document
    .querySelector(".testimonial-controls .prev")
    .addEventListener("click", function () {
      currentTestimonial =
  ...
  const customAmountContainer = document.querySelector(
  ...
  // Gallery filter
  const mediaFilterButtons = document.querySelectorAll(
  ...
  const lightboxVideoContainer = document.querySelector(
  ...
  galleryViewButtons.forEach((button, index) => {
    button.addEventListener("click", function (e) {
      ...
      if (isVideo) {
        ...
        const bgStyle = getComputedStyle(
  ...
  document
    ...
    .addEventListener("click", function () {
      currentLightboxIndex =
        (currentLightboxIndex + 1) % galleryViewButtons.length;
  ...
  forms.forEach((form) => {
    form.addEventListener("submit", async function (e) {
      ...
      submitButton.disabled = true; // Empêcher l'envoi multiple
